    ...
    public class TimeManager
    {
            ...
            DateTime endTime)
        {
            ...
            if (existingPoint != null)
            {
                ...
                // Note: We don't need to update SwingType or Direction as they should remain the same
                // No need to call AddSpecialSwingPoint since the point is already in the collection
            }
            else
            {
